...
- The pricing/guideline engines under `web/tools` (`window.YSP`/`GSP`/`TitleCost`, `termsheet.js` math) are the frozen source of truth. Reuse/wrap/port them into React — **never change their numbers or logic.**
