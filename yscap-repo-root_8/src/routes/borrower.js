...
/* A money value reaching a numeric column is PARSED, never passed through — a
   ...
   ("445,000") and the raw bind made the submit INSERT throw. See lib/fields.js. */
...
router.post('/applications', async (req, res) => {
  ...
  const r = await db.query(
    ...
    [me(req), b.llcId || null, JSON.stringify(b.propertyAddress), b.propertyType || null, b.units || null,
     b.program || null, require('../lib/fields').sanitizeLoanType(b.loanType), asg.purchasePrice, moneyValue(b.asIsValue) || null,   // #95: never a program
     moneyValue(b.arv) || null, moneyValue(b.rehabBudget) || null, b.loanOfficerName || null,
...
router.post('/drafts/:id/submit', async (req, res) => {
  ...
  const ins = await db.query(
    ...
    [me(req), b.llcId || null, JSON.stringify(b.propertyAddress), b.propertyType || null, b.units || null,
     b.program || null, require('../lib/fields').sanitizeLoanType(b.loanType), asg.purchasePrice, moneyValue(b.asIsValue) || null,   // #95: never a program
     moneyValue(b.arv) || null, moneyValue(b.rehabBudget) || null, officerId, b.loanOfficerName || null,
     b.rehabType || null, sqf.sqftPre, sqf.sqftPost,
     intField(b.requestedExpFlips), intField(b.requestedExpHolds), intField(b.requestedExpGround),
     asg.isAssignment, asg.underlying, asg.assignFee, JSON.stringify(redactPII(b)),
