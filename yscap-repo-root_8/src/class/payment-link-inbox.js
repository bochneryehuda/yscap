...
// Forward-looking forms ("once we have received your payment", "upon receipt of your
// payment") are a promise, not a receipt: one lookbehind fronts the whole test.
const FWD = "(?<!\\b(?:once|after|when|until|upon|as soon as) (?:we have |we've |we |your |the )?)";
const BODY_RECEIPT_RE = new RegExp(FWD +
  "(?:your receipt|view (?:your |the )?receipt|receipt (?:for|of) (?:your |the |this )?payment"
  + "|(?:your |the )?payment (?:was |has been )?(?:received|successful|processed|confirmed|completed)"
  + "|(?:we have |we've |we )?received your payment|paid in full|thank you for (?:your |the )?payment"
  + "|confirmation of (?:your |the )?payment|payment confirmation)", 'i');
