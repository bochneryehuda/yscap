...
const FIELDS = Object.freeze([
  ...
  { key: 'type_of_organization', status: 'derived', group: 'entity',
    ...
    note: 'The whole entity block hangs off this one answer. The back book was stamped `llc` without anybody choosing it (entity_type_confirmed = false), so the payload warns when the type on a file was assumed rather than stated.' },
  { key: 'acknowledgement_corporate_status', status: 'derived', group: 'entity',
    source: 'llcs.entity_type via lib/entity-type.docLabVariables',
    note: '"operating agreement and its members" for an LLC, "bylaws and its shareholders" for a corporation — DocLab\'s own wording, one string per type.' },
