...
async function _emailRow(id, to, opts, audience) {
  ...
  try {
    ...
    // provider wrapper and drives the portal-wide Email Center capture (email_messages,
    // src/lib/email-log.js). Kept ALONGSIDE the #442 sent_emails capture below (they
    // populate two independent stores — the portal-wide Email Center and the Draw
    // Management email view — neither breaks a send).
