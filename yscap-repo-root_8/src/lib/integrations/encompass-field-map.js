...
const REGISTRY = Object.freeze([
  ...
  pull({ key: 'deal_type', encompassFieldId: 'CX.DEALPROJECTTYPE', type: 'enum', compare: 'enum', valueMap: 'dealType', our: 'column:deal_type (Bridge → column:program)', note: 'Deal/project type — value-mapped (§6)' }),
