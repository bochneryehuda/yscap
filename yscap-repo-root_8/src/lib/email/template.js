    ...
    '<tr><td align="center" style="padding:32px 16px;">' +
      '<table role="presentation" width="600" cellpadding="0" cellspacing="0" ' +
        ...
        '<tr><td style="padding:30px 34px 10px;">' +
          ...
          greetHtml + body + figuresHtml + factsHtml + sectionsHtml + stepsHtml + progressHtml + calloutHtml + codeHtml + metaHtml + officerHtml + filesHtml + ctaHtml + noteHtml + quotedHtml +
        '</td></tr>' +
        /* footer */
