...
const CONDITIONS = [
  ...
  gold({ cond_no: 22, name: 'ASSIGNMENT FEE CAP', domain: 'valuation', trigger: T.is_assignment,
    required_evidence: 'Financeable assignment fee = the lesser of $75,000 or 15% of the purchase price; as-is value must support purchase price + fee; original two-party purchase agreement provided; any assignment escalated; non-arm\'s-length among the parties is ineligible. Fee math governed by the Gold engine.',
    checks: [S('Assignment fee ≤ lesser of $75,000 or 15% of purchase price (Gold-governed)', true), S('As-is value ≥ purchase price + assignment fee', true), S('Original two-party purchase agreement provided', true), S('Assignment escalated for review prior to purchase', true)],
