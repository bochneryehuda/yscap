...
const CONDITIONS = [
  ...
  { cond_no: 2120, name: 'CONDO/CONDOTEL REQUIREMENTS', domain: 'condo', scope: 'all_note_buyers', lifecycle: 'active_now', trigger: T.condo,
    ...
    clears_by: 'document_upload', pilot_template_code: 'cond_condo_docs', match_quality: 'exact', source_row: 33 },
  ...
  { cond_no: 1050, name: 'SS NUMBER VERIFICATION', domain: 'ssn_verification', scope: 'note_buyer', lifecycle: 'active_now', trigger: T.always,
    ...
    // Mapped to the REAL condition db/398 creates. It used to point at `rtl_p1_ssn`,
    ...
    clears_by: 'internal_verification', pilot_template_code: 'cond_ssn_verify_corrfirst', match_quality: 'exact', source_row: 40 },
  ...
  { cond_no: 10022, name: 'Cash Out Letter', domain: 'cash_out', scope: 'all_note_buyers', lifecycle: 'active_now', trigger: T.cash_out,
    required_evidence: 'A written explanation of the use of the cash-out proceeds.', checks: [], clears_by: 'document_upload', pilot_template_code: 'cond_cashout_letter', match_quality: 'exact', source_row: 73 },
