 ...
 *
 * WHY THE ADOPTION IS STAMPED (`llcs.adopted_*`, db/397) — the load-bearing safety property.
...
// may use its funds. Application-scoped, auto_apply='manual' (db/397) — an LLC-scoped code such as
