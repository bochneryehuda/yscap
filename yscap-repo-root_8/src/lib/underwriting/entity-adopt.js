 ...
 *
 * WHY THE ADOPTION IS STAMPED (`llcs.adopted_*`, db/400) — the load-bearing safety property.
...
// may use its funds. Application-scoped, auto_apply='manual' (db/400) — an LLC-scoped code such as
