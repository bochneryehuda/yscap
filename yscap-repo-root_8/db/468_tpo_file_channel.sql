-- ============================================================================
-- 468 — TPO PORTAL, foundation part 2: the TPO loan CHANNEL on the file +
--       the account-executive / account-manager file roles
--       (owner-directed 2026-08-04). Depends on db/467 (tpo_firms).
--
...
-- external-firm invariant as staff_users (db/467 §4), so the firm-scope gate can
