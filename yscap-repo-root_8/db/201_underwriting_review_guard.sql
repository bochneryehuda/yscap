-- ============================================================================
-- 201 — Document-underwriting-review clear-to-close guard (belt-and-suspenders).
--
-- The `underwriting_review_cleared` condition is the clear-to-close gate for the
-- PILOT document-underwriting engine (db/199): it may ONLY be marked 'satisfied'
...
-- fatals). This migration adds the DATABASE-LEVEL backstop db/199's header
