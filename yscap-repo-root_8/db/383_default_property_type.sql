-- ============================================================================
-- 383 - The property type is NEVER blank — it is derived from the unit count
...
--
-- The owner's rule mirrors the Fix-&-Flip program default (db/382): the property
...
-- the term (db/288) / property_type (db/322) / state (db/326) / program (db/382)
...
-- function. This is db/382's authoritative version verbatim EXCEPT the
...
-- line is identical to db/382 — do not drop the SoW-scope, semantic
