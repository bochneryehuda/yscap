-- ============================================================================
-- db/586 — WHO UNLOCKED THIS CONTACT: the vendor tells us, by email.
--
-- WHAT THIS CHANGES, AND WHY. db/585 was built on the belief that Elementix
...
--
-- `unlocked_by` (db/585) is OUR staff id and stays the thing every screen reads.
