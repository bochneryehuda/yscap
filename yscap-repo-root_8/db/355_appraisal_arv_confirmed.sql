-- ============================================================================
-- 355 — An officer can enter the ARV by hand, and that decision is recorded
--       (owner-directed 2026-07-28, closing an audit finding).
--
-- db/354 gave PILOT the ability to rewrite `applications.arv` from the
-- appraisal, but gave a human no matching way to correct it and no place to
-- record that they had. The As-Is has had both since db/353
