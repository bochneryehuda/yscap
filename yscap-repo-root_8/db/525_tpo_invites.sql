-- ============================================================================
-- 525 — TPO PORTAL, phase 2a: firm onboarding + the broker/processor INVITE.
--       Depends on db/523 (tpo_firms, staff_users external flags).
--
...
-- ----------------------------------------------------------------------------
-- (2) A firm-admin is always an external user (audit follow-up, db/523 §4
