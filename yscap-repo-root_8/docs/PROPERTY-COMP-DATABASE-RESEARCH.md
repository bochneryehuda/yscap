...
*Owner-directed, 2026-08-02. This is the design document db/406 and db/407 point at.*
...
`db/407` + `src/lib/research/valuation.js` + the `/internal/research/valuation/:id` screen.
