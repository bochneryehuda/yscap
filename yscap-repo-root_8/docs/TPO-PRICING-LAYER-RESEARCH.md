...
Both mirror the established TPO single-row + audit pattern (`tpo_firm_credit_credentials`, db/530), not the
...
1. **Foundation** — db/531 + `tpo-pricing.js` resolver + `pricing.js` threading + tests (this pass).
