...
**870 objects**, and a database rebuilt from the Prisma
...
rebuild a database from them.** The 613 numbered migrations in `db/` (highest `db/616`) remain the only thing that builds this database.
