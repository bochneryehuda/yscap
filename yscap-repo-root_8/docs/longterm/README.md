...
| **`TERM-SHEETS-AND-COMPARISON.md`** | **RESEARCH** — the term sheet (ID, frozen snapshot, replay, PDF) and the two comparison workflows, with the anchor rule and the break-even arithmetic |
