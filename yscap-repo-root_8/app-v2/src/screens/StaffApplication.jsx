  ...
  return (
    <>
      ...
      <Section hidden={!show('sec-documents')} id="sec-documents" summary={summaries['sec-documents']} title="Documents & exports" defaultOpen={false}
        info="Every document on the file — what it is, which condition it was uploaded to and why, and its full history (accepted, rejected, replaced, synced). The working set is on top, rejected/replaced versions are in the trash, and the TPR clean-file export is at the bottom."
