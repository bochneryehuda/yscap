                    ...
                    <React.Fragment key={it.id}>
                      <div className="q-row wf-row">
                        ...
                        <span className="wf-acts">
                          ...
                          {it.submission_type === 'escalation' && <Link className="btn primary small" to={`/internal/escalations?app=${it.application_id}`} title="Review the exception request and approve, decline, or counter-offer">Review exception</Link>}
