...
const REASON_COPY = {
  ...
  file_not_materialized_duplicate_pending: 'This task looks like a fresh ClickUp duplicate that still shows the source deal’s address, so PILOT is deliberately waiting rather than creating a twin file. Update the task’s address in ClickUp and the file appears on the next sync — or, if this genuinely is a second deal at the same address, create it now.',
