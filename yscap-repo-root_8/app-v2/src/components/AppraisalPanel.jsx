        ...
        <>
          ...
          {(sum.fatal > 0 || sum.warning > 0) && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, flexWrap: 'wrap' }}>
              ...
              {sum.blocksCtc && <span style={{ fontSize: 12.5, color: SEV.fatal.fg }}>The appraisal review can’t be signed off until every dealbreaker is resolved.</span>}
            </div>
          )}
          {findings.length > 0 ? (
...
// (The 2026-07-20 `export { Finding as AppraisalFinding }` re-use by the Document-review desk was
// removed 2026-07-30: appraisal findings render ONLY here, on the Appraisal tab — owner-directed.)
