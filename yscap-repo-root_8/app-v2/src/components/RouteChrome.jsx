...
const TITLES = [
  ...
  [/^\/tpo\/login/, 'Broker sign in'],
  [/^\/tpo\/accept/, 'Accept invitation'],
  [/^\/tpo\/team/, 'Your team'],
  [/^\/tpo\/new/, 'Enter a loan'],
  [/^\/tpo\/borrowers/, 'Your borrowers'],
  [/^\/tpo\/borrower\//, 'Borrower'],
  [/^\/tpo\/file\//, 'Loan file'],
  [/^\/tpo/, 'Broker portal'],
  ...
  [/^\/internal\/archived/, 'Archived files'],
  [/^\/internal\/team/, 'Team'],
