...
//
// The mapped code moved from `rtl_p1_ssn` to `cond_ssn_verify_corrfirst` (db/398,
...
// disposition and still surfaces as a coverage gap.
{
  ...
  assert.ok(ssn && ssn.pilot_template_code === 'cond_ssn_verify_corrfirst',
    'cond 1050 maps to the live SSN-verification condition (db/398), not the retired rtl_p1_ssn');
