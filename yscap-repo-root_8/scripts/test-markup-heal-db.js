'use strict';
/**
 * db/600 — RELEASING A FILE FROM A FROZEN COPY OF AN OLD COMPANY MARKUP.
 ...
 *
 * WHAT db/600 IS FOR (owner-reported 2026-08-20): the Term Sheet Studio used to
...
(async () => {
  ...
  // so db/600 runs here too — against nothing, since the fixtures below do not
