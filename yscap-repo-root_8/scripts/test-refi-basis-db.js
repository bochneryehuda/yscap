...
/* =====================================================================
   ...
   PART 1 — db/399, run against real rows: the implicit as-is value is
...
(async () => {
  ...
  const MIG = path.join(__dirname, '..', 'db', '399_refinance_sized_on_as_is_value.sql');

  try {
    /* ================================================================= *
     * PART 1 — db/399 on real rows
     * ================================================================= */
    console.log('\n--- db/399: the back book ---');
