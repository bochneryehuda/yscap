              ...
              {assetsItem && show(assetsItem) && (() => {
                ...
                return (
                  <ConditionRow
                    ...
                    subtitle={q
                      ? `Your ${app.registered_program === 'gold' ? 'Gold Standard' : app.registered_program === 'silver' ? 'Silver' : app.registered_program === 'manual' ? 'Manual' : 'Standard'} registration: verify ${money(liq)} in liquidity`
